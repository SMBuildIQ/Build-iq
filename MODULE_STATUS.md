...
| 24 | Notifications | FULL | In-app bell (poll-based), role- and user-targeted, fired on approval-required/quote-received/invoice-discrepancy. Now also emailed (same Resend integration as RFQ/negotiation send; logs instead of sending without RESEND_API_KEY) — closes a real gap this list previously tracked, see KNOWN_LIMITATIONS.md |
